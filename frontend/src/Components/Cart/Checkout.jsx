  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto py-10 px-6 tracking-tighter">
      ...
      <div>
        <div className="w-full flex justify-between items-center p-6">
          <div className="flex gap-2">
            <img
              ...
              src="https://img.freepik.com/premium-photo/free-photo-fashion-portrait-young-beautiful-confident-lady-wearing-trendy-winter-outfits_1124573-77227.jpg?ga=GA1.1.1324640529.1734293495&semt=ais_hybrid"
              alt=""
            />
            <p>name fsklfsk</p>
          </div>
        ...
        <div className="p-6">
          <button className="md:w-[211px] w-full h-[56px] bg-teal-500 text-base text-white font-medium hover:bg-black duration-300 font-Nunito rounded-[4px] cursor-pointer">
            Place Order
          </button>
        </div>
      </div>
